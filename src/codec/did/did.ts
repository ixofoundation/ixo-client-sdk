...
function createBaseDidCredential(): DidCredential {
  return { credType: [], issuer: "", issued: "", claim: undefined };
}
...
export const DidCredential = {
  ...
  fromJSON(object: any): DidCredential {
    return {
      credType: Array.isArray(object?.credType)
        ? object.credType.map((e: any) => String(e))
        : [],
  ...
  fromPartial<I extends Exact<DeepPartial<DidCredential>, I>>(
    object: I
  ): DidCredential {
    const message = createBaseDidCredential();
    ...
    message.claim =
      object.claim !== undefined && object.claim !== null
        ? Claim.fromPartial(object.claim)
        : undefined;
    return message;
  },
};
...
export const Claim = {
  ...
  fromJSON(object: any): Claim {
    return {
      ...
      KYCValidated: isSet(object.KYCValidated)
        ? Boolean(object.KYCValidated)
        : false,
    };
  },
...
function createBaseIxoDid(): IxoDid {
  return { did: "", verifyKey: "", encryptionPublicKey: "", secret: undefined };
}
...
export const IxoDid = {
  ...
  fromJSON(object: any): IxoDid {
    return {
      ...
      encryptionPublicKey: isSet(object.encryptionPublicKey)
        ? String(object.encryptionPublicKey)
        : "",
  ...
  fromPartial<I extends Exact<DeepPartial<IxoDid>, I>>(object: I): IxoDid {
    const message = createBaseIxoDid();
...
function createBaseSecret(): Secret {
  return { seed: "", signKey: "", encryptionPrivateKey: "" };
}
  ...
  fromJSON(object: any): Secret {
    return {
      ...
      encryptionPrivateKey: isSet(object.encryptionPrivateKey)
        ? String(object.encryptionPrivateKey)
        : "",
    };
  },
