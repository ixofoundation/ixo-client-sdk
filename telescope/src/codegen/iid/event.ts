...
export const IidDocumentCreatedEvent = {
  ...
  fromPartial(object: DeepPartial<IidDocumentCreatedEvent>): IidDocumentCreatedEvent {
    const message = createBaseIidDocumentCreatedEvent();
...
export const IidDocumentUpdatedEvent = {
  ...
  fromPartial(object: DeepPartial<IidDocumentUpdatedEvent>): IidDocumentUpdatedEvent {
    const message = createBaseIidDocumentUpdatedEvent();
    message.did = object.did ?? "";
    message.signer = object.signer ?? "";
    return message;
